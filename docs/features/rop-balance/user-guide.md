...
![Переход администратора в Баланс конкретного РОПа](../../.gitbook/assets/2-team-balance-button.png)
...
![Модалка изменения баланса клиента](../../.gitbook/assets/3-add-receipt-modal.png)
...
![Модалка Принять наличные от РОПа](../../.gitbook/assets/5-accept-cash-modal.png)
...
![Подтверждение удаления операции](../../.gitbook/assets/6-delete-confirmation-modal.png)
